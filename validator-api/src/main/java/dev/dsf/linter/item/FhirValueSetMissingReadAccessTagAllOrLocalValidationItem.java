 ...
 */
public class FhirValueSetMissingReadAccessTagAllOrLocalValidationItem extends FhirElementValidationItem
{
    /**
     ...
     */
    public FhirValueSetMissingReadAccessTagAllOrLocalValidationItem(
            File resourceFile,
            ...
            String description)
    {
        super(
                ...
                fhirReference,
                ValidationType.FHIR_VALUE_SET_MISSING_READ_ACCESS_TAG_ALL_OR_LOCAL,
                description
        );
    }
