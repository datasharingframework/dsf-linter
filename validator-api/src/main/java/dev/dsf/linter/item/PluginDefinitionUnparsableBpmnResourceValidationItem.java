 ...
 */
public class PluginDefinitionUnparsableBpmnResourceValidationItem extends PluginValidationItem {
     ...
     */
    public PluginDefinitionUnparsableBpmnResourceValidationItem(File file, String location, String message) {
