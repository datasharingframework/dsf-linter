 ...
 * @since 3.0.0
 */
public class PluginDefinitionBpmnFileReferencedFoundOutsideExpectedRootValidationItem extends PluginValidationItem {
     ...
     */
    public PluginDefinitionBpmnFileReferencedFoundOutsideExpectedRootValidationItem(
            String pluginName,
            File bpmnFile,
            String reference,
            String expectedRoot,
