 ...
 * Corresponds to {@link ValidationType#ACTIVITY_DEFINITION_DATE_NO_PLACEHOLDER}.
 */
public class FhirFileDateNoPlaceholderValidationItem extends FhirElementValidationItem
{
    ...
    {
        super(ValidationSeverity.WARN, resourceFile != null ? resourceFile.getName() : "unknown.xml", fhirReference, ValidationType.ACTIVITY_DEFINITION_DATE_NO_PLACEHOLDER,
    ...
    {
        super(ValidationSeverity.WARN, resourceFile != null ? resourceFile.getName() : "unknown.xml", fhirReference, ValidationType.ACTIVITY_DEFINITION_DATE_NO_PLACEHOLDER, description);
    }
}
