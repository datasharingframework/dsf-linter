 ...
 *
 * <p>
 * This is marked as an {@link ValidationSeverity#ERROR} since the listener will not function
 * correctly at runtime without implementing the required interface or extending the required class.
 * </p>
 *
 * Corresponds to {@link ValidationType#BPMN_USER_TASK_LISTENER_NOT_EXTENDING_OR_IMPLEMENTING_REQUIRED_CLASS}.
 */
public class BpmnUserTaskListenerNotExtendingOrImplementingRequiredClassValidationItem extends BpmnElementValidationItem
{
     ...
     */
    public BpmnUserTaskListenerNotExtendingOrImplementingRequiredClassValidationItem(String elementId, File bpmnFile, String processId, String className, String requiredType)
    {
