 ...
 *         <li>Inside it, <em>bpmnReports</em> and <em>fhirReports</em>, each containing
 ...
 *             <em>all</em> BPMN and FHIR items.</li>
 *       </ul>
 *   </li>
 * </ol>
 *
...
public class Main implements Callable<Integer>
{
     ...
     *   <li>Invoke the DSF validator methods for BPMN and FHIR, each returning their respective items.</li>
    ...
    public Integer call() throws Exception
    {
        ...
        List<AbstractValidationItem> allFhirItems = dsfValidator.validateAllFhirResourcesSplitNewStructure(projectDir, reportRoot);
