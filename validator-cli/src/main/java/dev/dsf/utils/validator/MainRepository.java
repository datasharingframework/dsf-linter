 ...
 * in a project that is cloned from a remote repository. It also validates
 * FHIR resources after compiling the project.
 * <p>
...
public class MainRepository
{
    public static void main(String[] args)
    {
        ...
        // Validate FHIR resources in src/main/resources/fhir
        System.out.println("\nValidating FHIR resources in: " + cloneDir.getAbsolutePath());
        FhirResourceValidator fhirValidator = new FhirResourceValidator();
        List<FhirElementValidationItem> fhirIssues = fhirValidator.validateAllFhirResources(cloneDir);

        // Convert FhirElementValidationItem list into a ValidationOutput, then print results
