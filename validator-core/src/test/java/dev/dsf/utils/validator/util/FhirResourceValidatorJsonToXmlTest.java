...
/**
 * Unit tests for {@link FhirResourceValidator} that verify correct conversion of FHIR JSON resources to XML.
 * <p>
 ...
 * @author Khalil Malla
 */
class FhirResourceValidatorJsonToXmlTest {
    ...
    private Document parseJsonToXmlDocument(String json) throws Exception {
        String xml = validator.convertJsonToXmlForTesting(json);
    ...
    class PositiveTests {
        ...
        void testConvertJsonWithSpecialCharacters() throws Exception {
            ...
            String xmlResult = validator.convertJsonToXmlForTesting(jsonWithSpecialChars);
    ...
    class NegativeTests {
        ...
        void testInvalidJsonInputs(String invalidJson) {
            Exception exception = assertThrows(Exception.class, () -> {
                validator.convertJsonToXmlForTesting(invalidJson);
            });
        ...
        void testConvertNullJsonString() {
            Exception exception = assertThrows(Exception.class, () -> {
                validator.convertJsonToXmlForTesting(null);
            });
        ...
        void testMalformedJsonSyntax() {
            ...
            Exception exception = assertThrows(Exception.class, () -> {
                validator.convertJsonToXmlForTesting(malformedJson);
            });
    ...
    class JsonNodeTests {
        ...
        void testJsonNodeParsingAndConversion() throws Exception {
            ...
            // Then convert via our validator
            Document doc = parseJsonToXmlDocument(simpleJson);
