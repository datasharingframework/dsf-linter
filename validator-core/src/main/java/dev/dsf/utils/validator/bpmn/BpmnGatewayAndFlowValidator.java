...
/**
 * <p>
 * The {@code BpmnGatewayAndFlowValidator} class handles validation logic for
 * ExclusiveGateway, SequenceFlow, and EventBasedGateway elements.
 * </p>
 *
 * <p>
 * References:
...
public class BpmnGatewayAndFlowValidator
{
    ...
    /**
     * Validates an {@link ExclusiveGateway}. Primarily defers to
     * {@link #validateSequenceFlow(SequenceFlow, List, File, String)} for condition checks,
     * but may place additional rules for name presence if needed.
     */
     ...
     *   <li>An error if the condition expression is missing and the sequence flow is not the default flow.</li>
     * </ul>
     */
