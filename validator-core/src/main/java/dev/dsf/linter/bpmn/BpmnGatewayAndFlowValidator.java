...
import dev.dsf.linter.FloatingElementType;
import dev.dsf.linter.FlowElementType;
import dev.dsf.linter.ValidationSeverity;
import dev.dsf.linter.ValidationType;
import dev.dsf.linter.item.BpmnElementValidationItem;
import dev.dsf.linter.item.BpmnElementValidationItemSuccess;
import dev.dsf.linter.item.BpmnFloatingElementValidationItem;
import dev.dsf.linter.item.BpmnFlowElementValidationItem;
