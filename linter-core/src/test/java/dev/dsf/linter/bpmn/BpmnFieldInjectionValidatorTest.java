...
import dev.dsf.linter.output.item.BpmnFieldInjectionMessageValueEmptyValidationItem;
import dev.dsf.linter.output.item.BpmnFieldInjectionNotStringLiteralValidationItem;
