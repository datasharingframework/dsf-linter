...
import dev.dsf.linter.output.item.PluginDefinitionNoFhirResourcesDefinedValidationItem;
import dev.dsf.linter.output.item.PluginDefinitionNoProcessModelDefinedValidationItem;
