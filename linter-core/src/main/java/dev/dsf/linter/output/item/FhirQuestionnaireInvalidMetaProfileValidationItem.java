 ...
 *
 * <p>This issue corresponds to {@link ValidationType#QUESTIONNAIRE_INVALID_META_PROFILE}.</p>
 */
public class FhirQuestionnaireInvalidMetaProfileValidationItem extends FhirElementValidationItem
{
    /**
     ...
     */
    public FhirQuestionnaireInvalidMetaProfileValidationItem(File resourceFile,
                                                             ...
                                                             boolean custom)
    {
        super(
                ...
                fhirReference,
                ValidationType.QUESTIONNAIRE_INVALID_META_PROFILE,
                description
        );
    }
}
