...
public class FhirTaskRequesterIdNotExistLintItem extends FhirElementLintItem {
     ...
     */
    public FhirTaskRequesterIdNotExistLintItem(File resourceFile, String fhirReference, String description) {
        super(LinterSeverity.ERROR,
                resourceFile != null ? resourceFile.getName() : "unknown.xml",
                fhirReference,
                LintingType.Fhir_TASK_REQUESTER_ID_MISSING,
                description);
    }
     ...
     * @param fhirReference the canonical URL or local identifier of the resource
     */
    public FhirTaskRequesterIdNotExistLintItem(File resourceFile, String fhirReference) {
