 ...
 *   <li>Use {@link PluginDefinitionLintItemSuccess} under {@code report/pluginReports/success/} when no leftovers exist.</li>
 * </ul>
 */
public final class PluginDefinitionProcessPluginRessourceNotLoadedLintItem extends PluginLintItem {
    /**
     ...
     */
    public PluginDefinitionProcessPluginRessourceNotLoadedLintItem(File file, String location, String message) {
