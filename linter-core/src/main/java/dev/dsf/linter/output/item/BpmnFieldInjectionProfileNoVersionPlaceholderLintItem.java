...
public class BpmnFieldInjectionProfileNoVersionPlaceholderLintItem extends BpmnElementLintItem {
     ...
     */
    public BpmnFieldInjectionProfileNoVersionPlaceholderLintItem(String elementId, File bpmnFile, String processId, String rawValue) {
        super(LinterSeverity.WARN, elementId, bpmnFile != null ? bpmnFile.getName() : "unknown.bpmn", processId, "Profile field injection does not contain a version placeholder: " + rawValue);
