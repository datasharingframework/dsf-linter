 ...
 * </p>
 *
 * Corresponds to {@link ValidationType#BPMN_USER_TASK_LISTENER_JAVA_CLASS_NOT_FOUND}.,
 * reused here to maintain type consistency.
 */
public class BpmnUserTaskListenerJavaClassNotFoundValidationItem extends BpmnElementValidationItem
{
     ...
     */
    public BpmnUserTaskListenerJavaClassNotFoundValidationItem(String elementId, File bpmnFile, String processId, String className)
    {
