...
/**
 * Represents a FHIR lint error indicating that a ValueSet is missing the required <code>title</code> element.
 * <p>
 ...
 * </p>
 */
public class FhirValueSetMissingTitleLintItem extends FhirElementLintItem {
    /**
     * Constructs a new lint error item for a ValueSet missing its <code>title</code> element.
     *
     ...
     */
    public FhirValueSetMissingTitleLintItem(
            File resourceFile,
        ...
        super(
                ...
                fhirReference,
                LintingType.FHIR_VALUE_SET_MISSING_TITLE,
