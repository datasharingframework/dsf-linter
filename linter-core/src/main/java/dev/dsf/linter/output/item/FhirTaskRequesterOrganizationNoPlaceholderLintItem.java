...
/**
 * <p>
 * Lint Item that represents an issue where a required placeholder
 ...
 *
 * <p>
 * This item corresponds to the {@link LintingType#FHIR_TASK_REQUESTER_ORGANIZATION_NO_PLACEHOLDER}
 ...
 * </pre>
 */
public class FhirTaskRequesterOrganizationNoPlaceholderLintItem extends FhirElementLintItem {
    /**
     * Creates a new {@code FhirFileVersionNoPlaceholderLintingItem} with a default description.
     *
     ...
     */
    public FhirTaskRequesterOrganizationNoPlaceholderLintItem(File resourceFile, String fhirReference) {
        super(
                LinterSeverity.WARN,
                resourceFile != null ? resourceFile.getName() : "unknown.xml",
                fhirReference,
                LintingType.FHIR_TASK_REQUESTER_ORGANIZATION_NO_PLACEHOLDER,
                "Required field does not contain a dynamic placeholder"
        );
    }

    /**
     * Creates a new {@code FhirFileVersionNoPlaceholderLintingItem} with a custom description.
     *
     * @param resourceFile  the FHIR resource file in which the issue was found (can be {@code null})
     * @param fhirReference the FHIR reference (e.g., {@code Task/example})
     * @param description   a custom description to provide additional context for the Lint issue
     */
    public FhirTaskRequesterOrganizationNoPlaceholderLintItem(File resourceFile, String fhirReference, String description) {
        super(
                LinterSeverity.WARN,
                resourceFile != null ? resourceFile.getName() : "unknown.xml",
                fhirReference,
