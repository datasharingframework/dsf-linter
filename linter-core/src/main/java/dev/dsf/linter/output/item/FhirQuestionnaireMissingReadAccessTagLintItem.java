 ...
 *
 * <p>This issue corresponds to {@link LintingType#QUESTIONNAIRE_MISSING_READ_ACCESS_TAG}.</p>
 */
public class FhirQuestionnaireMissingReadAccessTagLintItem extends FhirElementLintItem {
     ...
     */
    public FhirQuestionnaireMissingReadAccessTagLintItem(File resourceFile, String fhirReference) {
    ...
    public FhirQuestionnaireMissingReadAccessTagLintItem(File resourceFile,
        ...
        super(
                ...
                fhirReference,
                LintingType.QUESTIONNAIRE_MISSING_READ_ACCESS_TAG,
                description
        );
    }
}
