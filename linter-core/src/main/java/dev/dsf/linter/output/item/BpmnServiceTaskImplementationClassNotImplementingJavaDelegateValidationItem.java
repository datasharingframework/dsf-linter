...
public class BpmnServiceTaskImplementationClassNotImplementingJavaDelegateValidationItem extends BpmnElementValidationItem
{
    ...
    {
        super(ValidationSeverity.ERROR, elementId, bpmnFile != null ? bpmnFile.getName() : "unknown.bpmn", processId, "Service task implementation class does not implement JavaDelegate: " + className);
