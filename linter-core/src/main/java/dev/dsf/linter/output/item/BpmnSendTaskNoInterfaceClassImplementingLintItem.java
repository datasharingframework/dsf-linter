...
public class BpmnSendTaskNoInterfaceClassImplementingLintItem extends BpmnElementLintItem {
     ...
     */
    public BpmnSendTaskNoInterfaceClassImplementingLintItem(String elementId, File bpmnFile, String processId, String className) {
        super(LinterSeverity.ERROR, elementId, bpmnFile != null ? bpmnFile.getName() : "unknown.bpmn", processId, "Send task has no proper interface class implementation: " + className);
