...
/**
 * Linting item indicating that the total minimum cardinality (sum of {@code slice.min})
 ...
 *
 * <p>This issue corresponds to {@link LintingType#STRUCTURE_DEFINITION_SLICE_MIN_SUM_EXCEEDS_MAX}.</p>
 */
public class FhirStructureDefinitionSliceMinSumExceedsMaxLintItem extends FhirElementLintItem
{
    /**
     * Constructs a linting item for a violation where the total slice minimum cardinality
     ...
     */
    public FhirStructureDefinitionSliceMinSumExceedsMaxLintItem(File resourceFile,
                                                                ...
                                                                int sumOfSliceMin)
    {
        super(
                ...
                fhirReference,
                LintingType.STRUCTURE_DEFINITION_SLICE_MIN_SUM_EXCEEDS_MAX,
