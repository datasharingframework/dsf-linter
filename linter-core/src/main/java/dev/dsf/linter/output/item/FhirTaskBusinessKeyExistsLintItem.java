...
/**
 * Lint Item indicating that a FHIR {@code Task} resource contains an unexpected
 ...
 *
 * <p>This Lint issue corresponds to {@link LintingType#Fhir_TASK_BUSINESS_KEY_EXISTS}.</p>
 */
public class FhirTaskBusinessKeyExistsLintItem extends FhirElementLintItem {
    /**
     * Constructs a Lint Item indicating that a {@code business-key} input exists
     * when it must not.
     *
    ...
    /**
     * Constructs a Lint Item using the default message for unexpected {@code business-key} presence.
     *
     * @param resourceFile  the file in which the FHIR Task resource was found
     * @param fhirReference the canonical URL or local identifier of the resource
     */
