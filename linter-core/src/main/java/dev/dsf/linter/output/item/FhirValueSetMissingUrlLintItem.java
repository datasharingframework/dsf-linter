...
/**
 * Represents a FHIR lint error indicating that a ValueSet is missing the required <code>url</code> element.
 * <p>
...
public class FhirValueSetMissingUrlLintItem extends FhirElementLintItem {
    /**
     * Constructs a new lint error item for a ValueSet missing its <code>url</code> element.
     *
