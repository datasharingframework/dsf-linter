...
/**
 * Lint Item indicating that the {@code practitioners} input parameter in a task listener
 * has no value or is null/empty.
 * <p>
 * This lint item is created when an API v2 task listener defines a {@code practitioners}
 * input parameter (via {@code <camunda:inputParameter name="practitioners">}) within its
 ...
 * </p>
 */
public class BpmnPractitionersHasNoValueOrNullLintItem extends BpmnElementLintItem {
    /**
     * Constructs a new Lint Item for an empty or null practitioners input parameter.
     *
     ...
     */
    public BpmnPractitionersHasNoValueOrNullLintItem(LinterSeverity severity, String elementId, File bpmnFile, String processId) {
        super(severity, elementId, bpmnFile != null ? bpmnFile.getName() : "unknown.bpmn", processId,
                "practitioners input parameter in task listener has no value or is null/empty");
    }
     ...
     */
    public BpmnPractitionersHasNoValueOrNullLintItem(LinterSeverity severity, String elementId, File bpmnFile, String processId, String description) {
