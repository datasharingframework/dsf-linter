...
/**
 * Lint Item indicating that a FHIR {@code Task} resource contains duplicate
 ...
 *
 * <p>This Lint issue corresponds to {@link LintingType#Fhir_TASK_DUPLICATE_SLICE}.</p>
 */
public class FhirTaskInputDuplicateSliceLintItem extends FhirElementLintItem {
    /**
     * Constructs a Lint Item indicating duplicate slices in the {@code Task} resource.
     *
    ...
    /**
     * Constructs a Lint Item using the default message for a duplicate slice issue.
     *
     * @param resourceFile  the file in which the FHIR Task resource was found
     * @param fhirReference the canonical URL or local identifier of the resource
     */
