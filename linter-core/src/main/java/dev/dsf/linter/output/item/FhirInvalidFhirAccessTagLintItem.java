...
/**
 * Lint Item indicating that the FHIR access tag is invalid.
...
public class FhirInvalidFhirAccessTagLintItem extends FhirElementLintItem {
    /**
     * Constructs a new Lint Item for an invalid FHIR access tag using a default description.
     *
    ...
    /**
     * Constructs a new Lint Item for an invalid FHIR access tag using a custom description.
     *
     * @param resourceFile  the file where the FHIR resource was loaded from
     * @param fhirReference a canonical URL or local reference that identifies the resource
