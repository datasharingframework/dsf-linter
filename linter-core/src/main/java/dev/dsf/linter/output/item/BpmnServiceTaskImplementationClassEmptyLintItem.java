...
/**
 * Lint Item indicating that the implementation class for a service task is empty.
...
public class BpmnServiceTaskImplementationClassEmptyLintItem extends BpmnElementLintItem {
    ...
    /**
     * Constructs a new Lint Item for a service task with an empty implementation class.
     *
