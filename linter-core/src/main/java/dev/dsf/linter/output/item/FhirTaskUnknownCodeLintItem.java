...
/**
 * Lint Item indicating that a FHIR {@code Task} resource contains an unknown
 ...
 *
 * <p>This Lint issue corresponds to {@link LintingType#Fhir_TASK_UNKNOWN_CODE}.</p>
 */
public class FhirTaskUnknownCodeLintItem extends FhirElementLintItem {
    /**
     * Constructs a Lint Item indicating an unknown or unsupported {@code code}.
     *
    ...
    /**
     * Constructs a Lint Item using the default message for an unknown {@code code}.
     *
     * @param resourceFile  the file in which the FHIR Task resource was found
     * @param fhirReference the canonical URL or local identifier of the resource
     */
