...
/**
 * Lint Item indicating that the message intermediate catch event name is empty.
...
public class BpmnMessageIntermediateCatchEventNameEmptyLintItem extends BpmnElementLintItem {
    /**
     * Constructs a new Lint Item for a message intermediate catch event with an empty name.
     *
    ...
    /**
     * Constructs a new Lint Item for a message intermediate catch event with an empty name and a custom description.
     *
     * @param elementId   the BPMN element ID
     * @param bpmnFile    the BPMN file being validated
     * @param processId   the process definition ID or key
