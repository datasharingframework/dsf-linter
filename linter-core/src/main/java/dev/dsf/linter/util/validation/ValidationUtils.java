...
import dev.dsf.linter.output.item.BpmnValidationItem;
import dev.dsf.linter.output.item.FhirValidationItem;
import dev.dsf.linter.output.item.PluginValidationItem;
