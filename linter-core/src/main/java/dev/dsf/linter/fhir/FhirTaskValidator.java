 ...
 * during DSF plugin validation, typically from {@link DsfValidatorImpl}.</p>
 *
...
public final class FhirTaskValidator extends AbstractFhirInstanceValidator
{
     ...
     *
     * @see FhirTaskMissingInputValidationItem
     * @see FhirTaskInputRequiredCodingSystemAndCodingCodeValidationItem
     * @see FhirTaskInputMissingValueValidationItem
     * @see FhirTaskInputDuplicateSliceValidationItem
     * @see FhirTaskRequiredInputWithCodeMessageNameValidationItem
     * @see FhirTaskStatusRequiredInputBusinessKeyValidationItem
     * @see FhirTaskBusinessKeyExistsValidationItem
     * @see FhirTaskBusinessKeyCheckIsSkippedValidationItem
     * @see FhirTaskUnknownStatusValidationItem
     * @see FhirTaskCorrelationExistsValidationItem
     * @see FhirTaskCorrelationMissingButRequiredValidationItem
     * @see FhirTaskInputInstanceCountBelowMinItem
     * @see FhirTaskInputInstanceCountExceedsMaxItem
     * @see FhirTaskInputSliceCountBelowSliceMinItem
     * @see FhirTaskInputSliceCountExceedsSliceMaxItem
     * @see FhirTaskCouldNotLoadProfileValidationItem
     */
     ...
     *
     * @see FhirTaskRequesterIdNotExistValidationItem
     * @see FhirTaskRequesterIdNoPlaceholderValidationItem
     */
     ...
     * <ul>
     *   <li><strong>Existence check:</strong> Fails if the value is missing or blank, using
     *       {@link FhirTaskRecipientIdNotExistValidationItem}.</li>
     *   <li><strong>Placeholder check:</strong> If the value does not contain the required
     *       {@code #{organization}} placeholder, a
     *       {@link FhirTaskRecipientIdNoPlaceholderValidationItem}
     *       is added. If the placeholder is present, a success confirmation is reported.</li>
     * </ul>
     *
     * <p>Note: This method validates placeholder presence for development contexts but does not
     ...
     * @param out       the list of validation items to which results are appended
     *
     * @see FhirTaskRecipientIdNotExistValidationItem
     * @see FhirTaskRecipientIdNoPlaceholderValidationItem
     */
